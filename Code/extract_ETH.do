...
program define _ethfinal
    ...
    * harmonise id types to string so country files append cleanly into the pool
    ...
    keep country wave year season weight strataid ea_id hh_id holder_id parcel_id parcel_rentedin parcel_rentedout parcel_certificate parcel_purchased parcel_area_ha n_fields
    order country wave year season weight strataid ea_id hh_id holder_id parcel_id ///
          parcel_rentedin parcel_rentedout parcel_certificate parcel_purchased ///
